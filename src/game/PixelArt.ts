import { CRYSTAL_SPRITE_ROWS } from './CrystalSpriteFactory';
...
export const SPRITE_PLAYER_DOWN = buildSprite(CRYSTAL_SPRITE_ROWS.playerDown);
export const SPRITE_PLAYER_UP = buildSprite(CRYSTAL_SPRITE_ROWS.playerUp);
export const SPRITE_PLAYER_LEFT = buildSprite(CRYSTAL_SPRITE_ROWS.playerLeft);
export const SPRITE_TRAVELER = buildSprite(CRYSTAL_SPRITE_ROWS.traveler);
export const SPRITE_SHEEP = buildSprite(CRYSTAL_SPRITE_ROWS.sheep);
export const SPRITE_ROSE = buildSprite(CRYSTAL_SPRITE_ROWS.rose);
export const SPRITE_SHRINE = buildSprite(CRYSTAL_SPRITE_ROWS.shrine);
export const SPRITE_CRYSTAL = buildSprite(CRYSTAL_SPRITE_ROWS.crystal);
export const SPRITE_FIRE = buildSprite(CRYSTAL_SPRITE_ROWS.fire);
export const SPRITE_SIGN = buildSprite(CRYSTAL_SPRITE_ROWS.sign);
export const SPRITE_LEYLINE = buildSprite(CRYSTAL_SPRITE_ROWS.leyline);
export const SPRITE_DEMON = buildSprite(CRYSTAL_SPRITE_ROWS.demon);
